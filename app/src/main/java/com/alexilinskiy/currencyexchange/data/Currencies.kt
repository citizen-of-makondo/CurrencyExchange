...
data class Currencies(
    ...
    val EUR: EUR, val GBP: GBP, val HKD: HKD, val HRK: HRK,
    val HUF: HUF, val IDR: IDR, val ILS: ILS, val INR: INR,
    val ISK: ISK, val JPY: JPY, val KRW: KRW, val MXN: MXN,
    val MYR: MYR, val NOK: NOK, val NZD: NZD, val PHP: PHP,
    val PLN: PLN, val RON: RON, val RUB: RUB, val SEK: SEK,
...
data class HRK(val name: String, val symbol: String)
